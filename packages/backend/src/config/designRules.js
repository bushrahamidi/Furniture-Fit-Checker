      ...
      wallOccupation: [
        {
          ...
          includeMax: false,
          score: 40,
          warning: 'Coffee table may look too small for this wall.',
          recommendation: 'Choose a wider coffee table or pair it with complementary furniture.',
        },
        {
          rating: 'ACCEPTABLE',
          minPercentage: 40,
          ...
          includeMax: false,
          score: 75,
          recommendation: 'This coffee table is acceptable for the room width.',
        },
        {
          rating: 'GOOD',
          minPercentage: 50,
          ...
          includeMax: false,
          score: 100,
          recommendation: 'This coffee table is well proportioned for the room width.',
        },
        {
          rating: 'LARGE',
          minPercentage: 70,
          ...
          includeMax: true,
          score: 70,
          warning: 'Coffee table may feel large for this room.',
          recommendation: 'Confirm nearby walkways and visual balance before choosing this coffee table.',
        },
        {
          rating: 'TOO_LARGE',
          minPercentage: 80,
          includeMin: false,
          score: 30,
          warning: 'Coffee table is likely too large for this room.',
          recommendation: 'Choose a narrower coffee table to improve fit and room balance.',
        },
      ],
      physicalFitWarning: 'Coffee table dimensions exceed the room dimensions.',
      physicalFitRecommendation: 'Choose a coffee table that fits within the room width and length.',
      sofaWidthRatio: [
        {
          status: 'TOO_NARROW',
          minPercentage: 0,
      ...
      wallOccupation: [
        {
          ...
          includeMax: false,
          score: 40,
          warning: 'Dining table may look too small for this room.',
          recommendation: 'Choose a wider dining table or pair it with complementary furniture.',
        },
        {
          rating: 'ACCEPTABLE',
          minPercentage: 40,
          ...
          includeMax: false,
          score: 75,
          recommendation: 'This dining table is acceptable for the room width.',
        },
        {
          rating: 'GOOD',
          minPercentage: 50,
          ...
          includeMax: false,
          score: 100,
          recommendation: 'This dining table is well proportioned for the room width.',
        },
        {
          rating: 'LARGE',
          minPercentage: 70,
          ...
          includeMax: true,
          score: 70,
          warning: 'Dining table may feel large for this room.',
          recommendation: 'Confirm nearby walkways and visual balance before choosing this dining table.',
        },
        {
          rating: 'TOO_LARGE',
          minPercentage: 80,
          includeMin: false,
          score: 30,
          warning: 'Dining table is likely too large for this room.',
          recommendation: 'Choose a narrower dining table to improve fit and room balance.',
        },
      ],
