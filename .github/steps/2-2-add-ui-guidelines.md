...
## Goal
Create a clear set of UI guidelines to ensure the Furniture app has a set of rules around what the user interface should look like.
...
2. In the Copilot chat input field, ask Copilot to create a new file at `docs/ui-guidelines.md` that describes the core UI guidelines you want for your application. For example, require the use of Material components, specify color palettes and button styles, or accessibility requirements. The exact wording is up to you—just make sure your intent is clear!
